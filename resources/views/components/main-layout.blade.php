      ...
      <div class="flex min-h-0 flex-1 flex-col bg-sidebar">
        <div class="flex h-16 space-x-2 flex-shrink-0 items-center bg-white px-4">
          ...
          <div>
            ...
            <h1 class="font-semibold leading-3 text-indigo-600 text-sm">Event Attendance Module</h1>
          </div>
        </div>
        <div class="flex font-sans flex-1 flex-col overflow-y-auto">
          ...
          class="{{ request()->routeIs('accounts') ? 'bg-violet-800' : '' }} hover:bg-violet-800 text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-3 h-6 w-6 flex-shrink-0">
          ...
          class="{{ request()->routeIs('giveaway') ? 'bg-violet-800' : '' }} hover:bg-violet-800 text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-3 h-6 w-6 flex-shrink-0">
          ...
          class="{{ request()->routeIs('printer') ? 'bg-violet-800' : '' }} hover:bg-violet-800 text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium">
